...
def test_basic_metrics() -> None:
    ...
    assert np.isclose(annualised_return(returns, periods_per_year=12), 0.12682503013196977)
    ...
    assert np.isclose(certainty_equivalent(returns, risk_aversion=3.0, periods_per_year=12), 0.12)
